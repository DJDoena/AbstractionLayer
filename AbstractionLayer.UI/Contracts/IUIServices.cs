...
public interface IUIServices
{
    ...
    MessageResult ShowMessageBox(string text
        , string caption
    ...
    bool ShowOpenFileDialog(OpenFileDialogOptions options
        , out string fileName);
    ...
    /// <param name="fileName">The selected file name</param>
    /// <returns>Whether the dialog was confirmed or cancelled</returns>
    bool ShowSaveFileDialog(SaveFileDialogOptions options
        , out string fileName);
    ...
    /// <returns>Whether the dialog was confirmed or cancelled</returns>
    bool ShowFolderBrowserDialog(FolderBrowserDialogOptions options
        , out string folder);
}