namespace DoenaSoft.AbstractionLayer.IOServices.Implementations
{
    ...
    public sealed class FolderInfo : IFolderInfo, IEquatable<FolderInfo>, IComparable<IFolderInfo>, IComparable<FolderInfo>
    {
        ...
        /// </summary>
        public bool Equals(IFolderInfo other) => this.GetEquality(other);
        ...
        /// </summary>
        public bool Equals(FolderInfo other) => this.GetEquality(other);
        ...
        public int CompareTo(IFolderInfo other) => this.GetComparison(other);
        ...
        public int CompareTo(FolderInfo other) => this.GetComparison(other);
        ...
        /// </summary>
        public override bool Equals(object obj) => this.GetEquality(obj as IFolderInfo);
        ...
        private bool GetEquality(IFolderInfo other) => other != null && string.Equals(this.FullName ?? string.Empty, other.FullName ?? string.Empty, StringComparison.OrdinalIgnoreCase);
